...
allowed-tools:
  ...
  - Grep
  - Glob
  - WebFetch(domain:https://cbea.ms/git-commit/)
  - Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git show:*)
---

## Context

Follow the instructions below to write a good commit message. (ref: https://cbea.ms/git-commit/)

<good_commit_message_instructions>
# How to Write a Git Commit Message

![How to Write a Git Commit Message](https://cbea.ms/content/images/size/w2000/2021/01/git_commit_2x.png)

_**Contents:** [Introduction](#intro) | [The Seven Rules](#seven-rules) | [Tips](#tips)_
...
Write a good commit message for the modification during the current session.

ONLY commit files that were modified during the current session. Never use `git add -A` or `git add .`. Always specify exact file paths unless explicitly told to commit other files.
